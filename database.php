...
class database1{
    ...
    public $_cursor = NULL;   
      ...
      public function database1() {
        $this->_dbh = new PDO('mysql:host=localhost; dbname=hms','root','');
...
class database2{
    ...
    public function database2() {
        $this->_dbh = new PDO('sqlsrv:Server=172.18.11.221\SQLEXPRESS; Database=innovation','sa','abc13579');
        $this->_dbh->query('set names "utf8"');
    }
...
class database3{
    ...
    public function database3() {
        $this->_dbh = new PDO('sqlsrv:Server=172.18.11.221\SQLEXPRESS; Database=innovation2','sa','abc13579');
        $this->_dbh->query('set names "utf8"');
    }
